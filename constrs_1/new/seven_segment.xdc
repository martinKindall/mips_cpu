...
set_property PACKAGE_PIN V17 [get_ports selector]
...
#set_property PACKAGE_PIN V17 [get_ports {btns[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {btns[0]}]

#set_property PACKAGE_PIN V16 [get_ports {btns[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {btns[1]}]

#set_property PACKAGE_PIN W16 [get_ports {btns[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {btns[2]}]

#set_property PACKAGE_PIN W17 [get_ports {btns[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {btns[3]}]

#set_property PACKAGE_PIN W15 [get_ports {btns[4]}]
